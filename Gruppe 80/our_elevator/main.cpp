...
int main(){
	...
	//-------------------------------------------------------------------------------------------------------------------
	// Set up connections: Broadcast, local send and recieve, and ping/handshake
	//------------------------------------------------------------------------------------------------------------------
	...
	// Elevator ID determines which elevator that is MASTER, the one with lowest elevator_ID is master.
	// If MASTER elevator is offline, a new MASTER is temporarily assigned based on the next lowest elevator_ID
	// No connection between elevators means that every elevator is master, until connections are established again
